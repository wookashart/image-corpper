...
const Navigation = () => {
  ...
  return (
    <>
      <button
        className="absolute top-5 left-5 outline-none"
      ...
      <motion.div
        ...
        className="fixed top-0 left-0 bottom-0 py-5 pl-5 pr-16 bg-background-primary shadow-[0_0_10px_3px_rgba(0,0,0,0.4)] opacity-0"
      >
